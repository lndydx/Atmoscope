...
import com.lnxteam.atmoscope.notification.NotificationScheduler
...
class WeatherViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun fetchWeather(cityName: String) {
        val resolvedName = if (cities.containsKey(cityName)) cityName else "Bandung"
        val city = cities[resolvedName]!!
        setUsingGps(false)
        _isGpsLocation.value = false
        _selectedCity.value = resolvedName
        _selectedDistrict.value = ""
        _weatherState.value = UiState.Loading
        ...
        prefs.edit()
            ...
            .putString("last_manual_city", resolvedName)
            .apply()
