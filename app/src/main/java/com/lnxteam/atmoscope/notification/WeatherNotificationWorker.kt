package com.lnxteam.atmoscope.notification
...
import com.lnxteam.atmoscope.MainActivity
import com.lnxteam.atmoscope.R
import com.lnxteam.atmoscope.data.RetrofitInstance
    ...
    override suspend fun doWork(): Result {
        return try {
            ...
            val cityName = prefs.getString("last_gps_city", "")
                ?: prefs.getString("last_manual_city", "Kota Anda")
                ?: "Kota Anda"
            ...
            for (i in todayIndices) {
                ...
                if (isExtremeWeather(code)) {
                    ...
                    firstExtremeTime = forecast.hourly.time[i].substring(11, 16)
                    break
                }
            }
